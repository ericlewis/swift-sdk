                             ...
                             ASAuthorizationControllerPresentationContextProviding
{
    ...
    public func authorizationController(
        ...
        case let credentialRegistration as ASAuthorizationPlatformPublicKeyCredentialRegistration:
            ...
            let registrationResult = registrationContinuation?.resume(
                returning:
    ...
    public func authorizationController(
        ...
        if authorizationError.code == .canceled {
            // TODO:
            assertionContinuation?.resume(throwing: PasskeyManagerError.authorizationCancelled)
            registrationContinuation?.resume(throwing: PasskeyManagerError.authorizationCancelled)
        } else {
